...
if __name__ == '__main__':
    ...
    if True or 'horovod' in args.kv_store:
        ...
        if arg_params is not None and 'horovod' in args.kv_store:
            hvd.broadcast_parameters(arg_params, root_rank=0)
        if aux_params is not None and 'horovod' in args.kv_store:
